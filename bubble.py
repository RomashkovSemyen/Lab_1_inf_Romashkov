...
def plot_multiple_from_csv(filenames, labels=None, xlabel='X', ylabel='Y', title='Graph'):
    """
    Строит графики для нескольких CSV файлов с вычислением коэффициента наклона.

    Parameters:
    filenames (list): список путей к CSV файлам
    labels (list): метки для легенды (если None, используются имена файлов)
    ...
    for filename in filenames:
        ...
        if x_data and y_data:
            ...
            print(f"Предупреждение: нет данных в файле {filename}")
    ...
    # Сохранение графиков
    output_filename = 'multiple_plots_comparison.png'
...
# Пример использования для 3 файлов
